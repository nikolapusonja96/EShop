        ...
        <div class="row">
            ...
            <div id="main" class="col-md-9">
                ...
                <div class="store-filter clearfix">
                    <div class="pull-left">
                        ...
                        <div class="sort-filter">
                            ...
                            <a href="{{asset('/categories/women_watches/omega/ASC')}}" class="main-btn icon-btn"><i class="fa fa-arrow-circle-up"></i></a>
                            <a href="{{asset('/categories/women_watches/omega/DESC')}}" class="main-btn icon-btn"><i class="fa fa-arrow-circle-down"></i></a>
                        </div>
                    </div>
                    <div class="pull-right">
                        <div class="page-filter">
                            {{$women_omega_DESC->links()}}
                        </div>
                    </div>
                </div>
                <!-- /store top filter -->
                ...
                <div id="store">
                    ...
                    <div class="row" >
                        <!-- Product Single -->
                        @foreach($women_omega_DESC as $omega)
