        ...
        <div class="row">
            ...
            <div id="main" class="col-md-9">
                ...
                <div id="store">
                    ...
                    <div class="row" >
                        <!-- Product Single -->
                        @foreach($ulysse_nardin_rubber as $rubber)
                            <div class="col-md-4 col-sm-6 col-xs-6 ">
                                <div class="product product-single">
                                    <div class="product-thumb">

                                        <a href="{{asset('/product/'.$rubber->id_product)}}"> <button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button></a>
                                        <img src="{{asset($rubber->img_product)}}" alt="{{$rubber->description_img_product}}">
                                    </div>
                                    <div class="product-body">
                                        <h3 class="product-price">${{$rubber->price_product}}</h3>

                                        <h2 class="product-name">
                                            <a href="{{asset('/product/'.$rubber->id_product)}}">{{$rubber->name_product}}</a>
                                        </h2>
                                        <div class="product-btns">

                                            <a href="{{asset('/addToCart/'.$rubber->id_product)}}">
