        ...
        <div class="row">
            ...
            <div id="main" class="col-md-9">
                ...
                <div id="store">
                    ...
                    <div class="row" >
                        <!-- Product Single -->
                        @foreach($men_omega_titanium as $titanium)
                            <div class="col-md-4 col-sm-6 col-xs-6 ">
                                <div class="product product-single">
                                    <div class="product-thumb">

                                        <a href="{{asset('/product/'.$titanium->id_product)}}"> <button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button></a>
                                        <img src="{{asset($titanium->img_product)}}" alt="{{$titanium->description_img_product}}">
                                    </div>
                                    <div class="product-body">
                                        <h3 class="product-price">${{$titanium->price_product}}</h3>

                                        <h2 class="product-name">
                                            <a href="{{asset('/product/'.$titanium->id_product)}}">{{$titanium->name_product}}</a>
                                        </h2>
                                        <div class="product-btns">

                                            <a href="{{asset('/addToCart/'.$titanium->id_product)}}">
